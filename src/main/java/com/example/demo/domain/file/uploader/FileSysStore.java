...
//        multipartFile.transferTo(new java.io.File(getFullDir(storeFileName))); // 파일 저장
//
//        File file = new File(originalFilename, storeFileName,"");
//        file.setBoard(savedBoard);
//
//        return FileNameInfo.from(fileRepository.save(file)); // DB 에 저장
//    }
//
//
//
...
//        java.io.File file = new java.io.File(getFullDir(storeFileName));
//        file.delete();
//    }
//
//    /**
...
//
//
//    public FileNameInfo getPostAttachFile(List<File> files) {
//        for (File file : files) {
//            if (!FileUtil.isImageFile(file.getStoreFileName())) {
//                return FileNameInfo.from(file);
//            }
//        }
//        return null;
//    }
//
//    public List<FileNameInfo> getPostImagesFiles(List<File> files) {
//        return files.stream()
