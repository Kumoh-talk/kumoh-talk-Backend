...
import com.example.demo.domain.comment.controller.swagger.AbstractRecruitmentBoardCommentApi;
...
public class RecruitmentBoardCommentController extends AbstractRecruitmentBoardCommentApi {
    ...
    public ResponseEntity<ResponseBody<GlobalPageResponse<MyCommentResponse>>> getUserComments(
        ...
        return ResponseEntity.ok(createSuccessResponse(commentService.findCommentsByUserId(userId, pageable, EntireBoardType.fromRecruitmentBoardType(recruitmentBoardType))));
    }
    ...
    public ResponseEntity<ResponseBody<CommentInfoResponse>> createComment(
        ...
        return ResponseEntity.ok(createSuccessResponse(commentService.saveComment(userId, boardId, commentRequest, NotificationType.RECRUITMENT_BOARD_COMMENT)));
    }
