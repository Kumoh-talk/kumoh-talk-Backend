...
public abstract class AbstractBoardCommentApi implements CommentApi<BoardType> {
    @Override
    @Operation(
            summary = "마크다운 게시물 댓글 리스트 조회",
            description = "마크다운 게시글의 댓글 리스트를 조회합니다."
    )
    ...
    @ApiResponseExplanations(
            success = @ApiSuccessResponseExplanation(
                    ...
                    description = "마크다운 게시물 댓글 리스트 조회 성공\n"
                            + "댓글은 페이징 처리되지 않습니다\n"
    ...
    @Override
    @Operation(
            summary = "마크다운 게시물 대상 사용자 작성 댓글 페이지 조회",
            description = "사용자의 마크다운 게시물 대상 댓글 페이지를 조회합니다."
    )
    ...
    @ApiResponseExplanations(
            success = @ApiSuccessResponseExplanation(
                    ...
                    description = "마크다운 게시물 대상 사용자 댓글 페이지 조회 성공"),
            errors = {
    ...
    public abstract ResponseEntity<ResponseBody<GlobalPageResponse<MyCommentResponse>>> getUserComments(
            ...
            @Parameter(description = "마크다운 게시물 타입(notice, seminar)", example = "notice") @RequestParam BoardType boardType);

    @Override
    @Operation(
            summary = "마크다운 게시물 댓글 저장",
            description = "마크다운 게시글에 댓글을 저장합니다."
    )
    ...
    @Override
    @Operation(
            summary = "마크다운 게시물 댓글 수정",
            description = "commentId에 해당하는 마크다운 게시물의 댓글을 수정합니다."
    )
    @ApiResponse(content = @Content(mediaType = "application/json", schema = @Schema(implementation = CommentInfoResponse.class)))
    @ApiResponseExplanations(
            success = @ApiSuccessResponseExplanation(
                    responseClass = CommentInfoResponse.class,
                    description = "마크다운 게시물 댓글 수정 성공"),
            errors = {
    ...
    @Override
    @Operation(
            summary = "마크다운 게시물 댓글 삭제",
            description = "사용자가 작성한 commentId에 해당하는 마크다운 게시물 댓글을 삭제합니다."
    )
    @ApiResponseExplanations(
            success = @ApiSuccessResponseExplanation(
                    description = "마크다운 게시물 댓글 삭제 성공"),
            errors = {
                    @ApiErrorResponseExplanation(errorCode = ErrorCode.COMMENT_NOT_FOUND),
                    @ApiErrorResponseExplanation(errorCode = ErrorCode.ACCESS_DENIED)
            }
